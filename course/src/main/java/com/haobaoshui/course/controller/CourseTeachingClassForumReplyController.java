...
@RestController
@RequestMapping("courseforumreply/v1")
public class CourseTeachingClassForumReplyController extends BaseController {
    ...
    @Autowired
    public CourseTeachingClassForumReplyController(CourseTeachingClassForumReplyService courseTeachingClassForumReplyService) {
