...
@RestController
@RequestMapping("coursehomeworkscore/v1")
public class CourseTeachingClassHomeworkStudentScoreController extends BaseController {

    private final CourseTeachingClassHomeworkStudentScoreService courseTeachingClassHomeworkStudentScoreService;
    @Autowired
    private HttpServletRequest request;


    @Autowired
    public CourseTeachingClassHomeworkStudentScoreController(CourseTeachingClassHomeworkStudentScoreService courseTeachingClassHomeworkStudentScoreService) {
